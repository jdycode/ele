...
@section("content")
    <form class="container" action="" method="post" enctype="multipart/form-data" style="width: fit-content">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="exampleInputPassword1" placeholder="活动开始时间" name="start_time">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">活动结束时间</label>
            <input type="date" class="form-control" id="exampleInputPassword1" placeholder="活动结束时间" name="end_time">
        </div>
        <!-- 实例化编辑器 -->

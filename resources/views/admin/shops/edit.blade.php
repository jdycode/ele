...
@section("content")
    <form class="container" action="" method="post" enctype="multipart/form-data" style="width: min-content">
        ...
        是否品牌：<div class="radio">
            <label>
                <input type="radio" @if($shops->brand===1) checked @endif name="brand" value="1"> 是
            </label>
            <label>
                <input type="radio" @if($shops->brand===0) checked @endif name="brand" value="0"> 否
            </label>
        </div>
        是否准时送达：<div class="radio">
            <label>
                <input type="radio"  @if($shops->on_time===1) checked @endif   name="on_time" value="1"> 是
            </label>
            <label>
                <input type="radio" @if($shops->on_time===0) checked @endif name="on_time" value="0"> 否
            </label>
        </div>
        是否蜂鸟配送：<div class="radio" >
            <label>
                <input type="radio"  @if($shops->fengniao===1) checked @endif   name="fengniao" value="1"> 是
            </label>
            <label>
                <input type="radio"  @if($shops->fengniao===0) checked @endif   name="fengniao" value="0"> 否
            </label>
        </div>
        是否保标记：<div class="radio" >
            <label>
                <input type="radio"  @if($shops->bao===1) checked @endif   name="bao" value="1"> 是
            </label>
            <label>
                <input type="radio" @if($shops->bao===0) checked @endif  name="bao" value="0"> 否
            </label>
        </div>
        是否票标记：<div class="radio" >
            <label>
                <input type="radio" @if($shops->piao===1) checked @endif  name="piao" value="1"> 是
            </label>
            <label>
                <input type="radio" @if($shops->piao===0) checked @endif  name="piao" value="0"> 否
            </label>
        </div>
        是否准标记：<div class="radio" >
            <label>
                <input type="radio" @if($shops->zhun===1) checked @endif  name="zhun" value="1"> 是
            </label>
            <label>
                <input type="radio" @if($shops->zhun===0) checked @endif  name="zhun" value="0"> 否
            </label>
        </div>
        状态： <div class="radio" >
            <label>
